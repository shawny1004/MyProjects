        ...
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
           ...
           <form action="${url }" method="post">
             <a href="${url2 }add.do"><span style="font-size: 20px;font-weight: bold;">Add Bus</span></a>
         Plate Number：<input type="text" name="plateNumber" value="${plateNumber}" />
