        ...
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
           ...
           <form action="${url }" method="post">
             <a href="${url2 }add.do"><span style="font-size: 20px;font-weight: bold;">Add Route</span></a>
         Route Number：<input type="text" name="routeNumber" value="${routeNumber}" />
          ...
          <table>
            ...
            <c:forEach items="${list}" var="bean">
              <tr>
                <td>${bean.routeNumber }</td>
                <td>${bean.driver.username }</td>
                <td>${bean.bus.plateNumber }</td>
                <td>${bean.runningTImeStart }</td>
                <td>${bean.runningTImeEnd }</td>
                <td>${bean.gap }</td>
