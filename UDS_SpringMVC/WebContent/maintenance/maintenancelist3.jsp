        ...
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
           ...
           <form action="${url }" method="post">
               ...
               Service Type：<input type="text" name="maintenanceType" value="${maintenanceType}" />
          ...
          <table>
            ...
            <c:forEach items="${list}" var="bean">
              <tr>
            	...
            	<c:if test="${bean.status=='scheduled'}">
                  <a href="${url2 }update5.do?id=${bean.id }" onclick=" return confirm('Sure to add Report?'); "><img src="resources/images/icons/pencil.png" />Add Maintenance Report</a> 
                 </c:if>		
