...
function checkform(){
	...
	if(document.getElementById("scheduledTImeid").value==""){
		
		alert('Appointment Time Cannot be empty !');
		return false;
	}
          ...
          <form action="${url }" method="post" onsubmit="return checkform()" >
            ...
            <p>
             ...
             <p>
              ...
              <input class="text-input small-input" type="text"  name="scheduledTIme" id="scheduledTImeid" value="${bean.scheduledTIme }"  />
             ...
             <textarea rows="7" cols="50" name="report"></textarea>
