        ...
        <div class="tab-content default-tab" id="tab1">
          <form action="${url }" method="post" onsubmit="return checkform()" enctype="multipart/form-data">
            ...
            <p>
              ...
              <input class="text-input small-input" type="text"  name="dormNum" value="${bean.dormNum }" id="dormNumid" />
              
            </p>
            
            <p>
              <label>Room Number</label>
              <input class="text-input small-input" type="text"  name="roomNum" value="${bean.roomNum }" id="roomNumid" />
              
            </p>
            
            <p>
              <label>Monthly Price</label>
              <input class="text-input small-input" type="text"  name="price"  value="${bean.price }" id="priceid" />
              
            </p>
            
            <p>
              <label>Area</label>
              <input class="text-input small-input" type="text"  name="area" value="${bean.area }" id="areaid" />
              
            </p>
            
            <p>
              <label>Total Number of Room</label>
              <input class="text-input small-input" type="text"  name="number_of_room" value="${bean.number_of_room }" id="idroom" />
