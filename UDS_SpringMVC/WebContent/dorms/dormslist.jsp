        ...
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
           ...
           <form action="${url }" method="post">
             <a href="${url2 }add.do"><span style="font-size: 20px;font-weight: bold;">Add New Dorm</span></a>
            ...
            <c:forEach items="${list}" var="bean">
              <tr>
                ...
                <td>
                  ...
                  <a href="${url2 }update5.do?id=${bean.id }" ><img src="resources/images/icons/pencil.png" />Upload Picture</a> 
